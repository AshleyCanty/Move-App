...
class DarkButton: UIButton {
    ...
    override func layoutSubviews() {
        ...
        let borderGradientTop = Colors.GreenLight.cgColor
        let borderGradientBottom = Colors.GreenMedium.cgColor
        ...
        // Background:
        let backgroundGradientTop = Colors.PinkDark.cgColor
        let backgroundGradientBottom = Colors.PurpleMedium.cgColor
